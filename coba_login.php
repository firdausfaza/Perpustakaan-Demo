...
$login = mysqli_query($menyambung,"SELECT * FROM tbadmin where nama_admin = '$nama_admin' and password_admin='$password_admin'");
...
$x	= mysqli_fetch_array($login);
	...
	if($ada > 0){
		...
		echo "<script>alert('Login Gagal, Periksa Kembali Password'); window.location='index.php'</script>";
	}
