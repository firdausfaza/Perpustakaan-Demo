...
<div class="row">
          <div class="col-xl-3 col-sm-6 mb-3">
              <?php
              include "../koneksi.php";
                $query = mysqli_query($menyambung,"SELECT nama_anggota FROM tbanggota");
          ...
          <div class="col-xl-3 col-sm-6 mb-3">
             <?php
              include "../koneksi.php";
                $queryBuku = mysqli_query($menyambung,"SELECT judul_buku FROM tbbuku");
          ...
          <div class="col-xl-3 col-sm-6 mb-3">
              <?php
              include "../koneksi.php";
                $queryBukuPinjam = mysqli_query($menyambung,"SELECT id_pinjam FROM tbpeminjaman where status = 'PINJAM'");
