...
<div class="card mb-3">
          ...
          <div class="card-body">
            <div class="table-responsive">
            	<?php
            	include "../koneksi.php";
            	$tampil = mysqli_query($menyambung,"SELECT * FROM tbanggota");
              ...
              <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                    	<a class="btn btn-info" href="beranda.php?hal=InfoAnggota&id_anggota=<?php echo $data['id_anggota'] ?>">Info Anggota</a>
